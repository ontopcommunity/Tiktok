...
export default async function handler(req, res) {
  ...
  try {
    ...
    try {
      ...
      if (dataMatch) {
        ...
        const itemStruct =
          ...
          defaultScope.ItemModule?.[Object.keys(defaultScope.ItemModule || {})[0]];
        if (itemStruct) {
      ...
      console.error("HTML scrape fail:", e.message);
    }
    ...
    if (text.trim().startsWith("{")) {
      const tikwmData = JSON.parse(text);
      v = tikwmData.data || {};
    }
    ...
    const result = {
      ...
      video_data: {
        ...
        create_time: v.create_time || createTime || null,
      ...
      images: scrapedImages || v.images || null,
    };
